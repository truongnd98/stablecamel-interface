			...
			<Box sx={main}>
				...
				<Box sx={card}>
					...
					>
						...
						asset. Cryptocurrencies, digital assets, and investing have many
						risks, including risk of losses beyond principal investment or
						purchase amount. Past performance is not indicative of future
